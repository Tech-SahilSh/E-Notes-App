...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom" style="position:fixed;top:0; width:100vw;">
  <a class="navbar-brand" href="#"><i class="fa fa-pencil-square" aria-hidden="true"></i>E-NOTES</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Note</a>
      </li>
      <li class="nav-item">
